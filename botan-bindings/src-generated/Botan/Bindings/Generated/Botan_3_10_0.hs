...
module Botan.Bindings.Generated.Botan_3_10_0 where
...
{-| __C declaration:__ @BOTAN_FFI_API_VERSION@
    ...
    __defined at:__ @botan\/ffi.h:72:9@

    __exported by:__ @botan\/ffi.h@
-}
bOTAN_FFI_API_VERSION :: FC.CInt
bOTAN_FFI_API_VERSION = (20250829 :: FC.CInt)

{-| Error codes

  If you add a new value here be sure to also add it in botan_error_description

__C declaration:__ @BOTAN_FFI_ERROR@

__defined at:__ @botan\/ffi.h:114:6@
...
{-| __C declaration:__ @BOTAN_FFI_ERROR_BAD_MAC@
    ...
    __defined at:__ @botan\/ffi.h:120:4@
...
{-| __C declaration:__ @BOTAN_FFI_ERROR_INSUFFICIENT_BUFFER_SPACE@
    ...
    __defined at:__ @botan\/ffi.h:123:4@
...
{-| __C declaration:__ @BOTAN_FFI_ERROR_SYSTEM_ERROR@
    ...
    __defined at:__ @botan\/ffi.h:128:4@
...
{-| __C declaration:__ @BOTAN_FFI_ERROR_INVALID_KEY_LENGTH@
    ...
    __defined at:__ @botan\/ffi.h:135:4@
...
{-| __C declaration:__ @BOTAN_FFI_ERROR_NOT_IMPLEMENTED@
    ...
    __defined at:__ @botan\/ffi.h:138:4@
...
{-| __C declaration:__ @BOTAN_FFI_ERROR_ROUGHTIME_ERROR@
    ...
    __defined at:__ @botan\/ffi.h:143:4@
...
{-| __C declaration:__ @BOTAN_FFI_ERROR_UNKNOWN_ERROR@
    ...
    __defined at:__ @botan\/ffi.h:146:4@
...
__defined at:__ @botan\/ffi.h:152:15@
...
__defined at:__ @botan\/ffi.h:161:15@

__exported by:__ @botan\/ffi.h@
-}
newtype Botan_view_bin_fn_Deref = Botan_view_bin_fn_Deref
  { un_Botan_view_bin_fn_Deref :: Botan_view_ctx -> (Ptr.Ptr HsBindgen.Runtime.Prelude.Word8) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt
  }

foreign import ccall safe "wrapper" toBotan_view_bin_fn_Deref ::
     Botan_view_bin_fn_Deref
  -> IO (Ptr.FunPtr Botan_view_bin_fn_Deref)

foreign import ccall safe "dynamic" fromBotan_view_bin_fn_Deref ::
     Ptr.FunPtr Botan_view_bin_fn_Deref
  -> Botan_view_bin_fn_Deref

instance HsBindgen.Runtime.FunPtr.ToFunPtr Botan_view_bin_fn_Deref where

  toFunPtr = toBotan_view_bin_fn_Deref

instance HsBindgen.Runtime.FunPtr.FromFunPtr Botan_view_bin_fn_Deref where

  fromFunPtr = fromBotan_view_bin_fn_Deref

instance ( TyEq ty ((HsBindgen.Runtime.HasCField.CFieldType Botan_view_bin_fn_Deref) "un_Botan_view_bin_fn_Deref")
         ) => GHC.Records.HasField "un_Botan_view_bin_fn_Deref" (Ptr.Ptr Botan_view_bin_fn_Deref) (Ptr.Ptr ty) where

  getField =
    HsBindgen.Runtime.HasCField.ptrToCField (Data.Proxy.Proxy @"un_Botan_view_bin_fn_Deref")

instance HsBindgen.Runtime.HasCField.HasCField Botan_view_bin_fn_Deref "un_Botan_view_bin_fn_Deref" where

  type CFieldType Botan_view_bin_fn_Deref "un_Botan_view_bin_fn_Deref" =
    Botan_view_ctx -> (Ptr.Ptr HsBindgen.Runtime.Prelude.Word8) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt
...
newtype Botan_view_bin_fn = Botan_view_bin_fn
  { un_Botan_view_bin_fn :: Ptr.FunPtr Botan_view_bin_fn_Deref
  }
  deriving stock (Eq, Ord, Show)
  deriving newtype (F.Storable)
...
__defined at:__ @botan\/ffi.h:170:15@

__exported by:__ @botan\/ffi.h@
-}
newtype Botan_view_str_fn_Deref = Botan_view_str_fn_Deref
  { un_Botan_view_str_fn_Deref :: Botan_view_ctx -> (Ptr.Ptr FC.CChar) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt
  }

foreign import ccall safe "wrapper" toBotan_view_str_fn_Deref ::
     Botan_view_str_fn_Deref
  -> IO (Ptr.FunPtr Botan_view_str_fn_Deref)

foreign import ccall safe "dynamic" fromBotan_view_str_fn_Deref ::
     Ptr.FunPtr Botan_view_str_fn_Deref
  -> Botan_view_str_fn_Deref

instance HsBindgen.Runtime.FunPtr.ToFunPtr Botan_view_str_fn_Deref where

  toFunPtr = toBotan_view_str_fn_Deref

instance HsBindgen.Runtime.FunPtr.FromFunPtr Botan_view_str_fn_Deref where

  fromFunPtr = fromBotan_view_str_fn_Deref

instance ( TyEq ty ((HsBindgen.Runtime.HasCField.CFieldType Botan_view_str_fn_Deref) "un_Botan_view_str_fn_Deref")
         ) => GHC.Records.HasField "un_Botan_view_str_fn_Deref" (Ptr.Ptr Botan_view_str_fn_Deref) (Ptr.Ptr ty) where

  getField =
    HsBindgen.Runtime.HasCField.ptrToCField (Data.Proxy.Proxy @"un_Botan_view_str_fn_Deref")

instance HsBindgen.Runtime.HasCField.HasCField Botan_view_str_fn_Deref "un_Botan_view_str_fn_Deref" where

  type CFieldType Botan_view_str_fn_Deref "un_Botan_view_str_fn_Deref" =
    Botan_view_ctx -> (Ptr.Ptr FC.CChar) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt
...
newtype Botan_view_str_fn = Botan_view_str_fn
  { un_Botan_view_str_fn :: Ptr.FunPtr Botan_view_str_fn_Deref
  }
  deriving stock (Eq, Ord, Show)
  deriving newtype (F.Storable)
...
{-| __C declaration:__ @BOTAN_FFI_HEX_LOWER_CASE@
    ...
    __defined at:__ @botan\/ffi.h:247:9@
...
{-| __C declaration:__ @botan_rng_struct@

    __defined at:__ @botan\/ffi.h:289:16@
...
__defined at:__ @botan\/ffi.h:289:34@
...
{-| __C declaration:__ @botan_hash_struct@

    __defined at:__ @botan\/ffi.h:381:16@
...
{-| __C declaration:__ @botan_hash_t@
    ...
    __defined at:__ @botan\/ffi.h:381:35@
...
{-| __C declaration:__ @botan_mac_struct@

    __defined at:__ @botan\/ffi.h:461:16@
...
{-| __C declaration:__ @botan_mac_t@
    ...
    __defined at:__ @botan\/ffi.h:461:34@
...
{-| __C declaration:__ @botan_cipher_struct@

    __defined at:__ @botan\/ffi.h:557:16@
...
{-| __C declaration:__ @botan_cipher_t@
    ...
    __defined at:__ @botan\/ffi.h:557:37@
...
{-| __C declaration:__ @BOTAN_CIPHER_INIT_FLAG_DECRYPT@
    ...
    __defined at:__ @botan\/ffi.h:561:9@
...
{-| __C declaration:__ @botan_block_cipher_struct@

    __defined at:__ @botan\/ffi.h:855:16@
...
{-| __C declaration:__ @botan_block_cipher_t@
    ...
    __defined at:__ @botan\/ffi.h:855:43@
...
{-| __C declaration:__ @botan_mp_struct@

    __defined at:__ @botan\/ffi.h:921:16@
...
{-| __C declaration:__ @botan_mp_t@
    ...
    __defined at:__ @botan\/ffi.h:921:33@
...
{-| __C declaration:__ @botan_asn1_oid_struct@

    __defined at:__ @botan\/ffi.h:1142:16@
...
{-| __C declaration:__ @botan_asn1_oid_t@
    ...
    __defined at:__ @botan\/ffi.h:1142:39@
...
{-| __C declaration:__ @botan_ec_group_struct@

    __defined at:__ @botan\/ffi.h:1191:16@
...
{-| __C declaration:__ @botan_ec_group_t@
    ...
    __defined at:__ @botan\/ffi.h:1191:39@
...
{-| __C declaration:__ @botan_privkey_struct@

    __defined at:__ @botan\/ffi.h:1325:16@
...
{-| __C declaration:__ @botan_privkey_t@
    ...
    __defined at:__ @botan\/ffi.h:1325:38@
...
{-| __C declaration:__ @BOTAN_CHECK_KEY_EXPENSIVE_TESTS@
    ...
    __defined at:__ @botan\/ffi.h:1348:9@
...
{-| __C declaration:__ @BOTAN_PRIVKEY_EXPORT_FLAG_PEM@
    ...
    __defined at:__ @botan\/ffi.h:1419:9@
...
{-| __C declaration:__ @BOTAN_PRIVKEY_EXPORT_FLAG_RAW@
    ...
    __defined at:__ @botan\/ffi.h:1420:9@
...
{-| __C declaration:__ @botan_pubkey_struct@

    __defined at:__ @botan\/ffi.h:1558:16@
...
{-| __C declaration:__ @botan_pubkey_t@
    ...
    __defined at:__ @botan\/ffi.h:1558:37@
...
{-| __C declaration:__ @botan_pk_op_encrypt_struct@

    __defined at:__ @botan\/ffi.h:1928:16@
...
{-| __C declaration:__ @botan_pk_op_encrypt_t@
    ...
    __defined at:__ @botan\/ffi.h:1928:44@
...
{-| __C declaration:__ @botan_pk_op_decrypt_struct@

    __defined at:__ @botan\/ffi.h:1952:16@
...
{-| __C declaration:__ @BOTAN_PUBKEY_DER_FORMAT_SIGNATURE@
    ...
    __defined at:__ @botan\/ffi.h:1973:9@
...
{-| __C declaration:__ @botan_pk_op_sign_struct@

    __defined at:__ @botan\/ffi.h:1975:16@
...
{-| __C declaration:__ @botan_pk_op_sign_t@
    ...
    __defined at:__ @botan\/ffi.h:1975:41@
...
{-| __C declaration:__ @botan_pk_op_verify_struct@

    __defined at:__ @botan\/ffi.h:1995:16@
...
{-| __C declaration:__ @botan_pk_op_verify_t@
    ...
    __defined at:__ @botan\/ffi.h:1995:43@
...
{-| __C declaration:__ @botan_pk_op_ka_struct@

    __defined at:__ @botan\/ffi.h:2014:16@
...
{-| __C declaration:__ @botan_pk_op_ka_t@
    ...
    __defined at:__ @botan\/ffi.h:2014:39@
...
{-| __C declaration:__ @botan_pk_op_kem_encrypt_struct@

    __defined at:__ @botan\/ffi.h:2043:16@
...
{-| __C declaration:__ @botan_pk_op_kem_encrypt_t@
    ...
    __defined at:__ @botan\/ffi.h:2043:48@
...
{-| __C declaration:__ @botan_pk_op_kem_decrypt_struct@

    __defined at:__ @botan\/ffi.h:2073:16@
...
{-| __C declaration:__ @botan_pk_op_kem_decrypt_t@
    ...
    __defined at:__ @botan\/ffi.h:2073:48@
...
{-| __C declaration:__ @botan_x509_cert_struct@

    __defined at:__ @botan\/ffi.h:2137:16@
...
{-| __C declaration:__ @botan_x509_cert_t@
    ...
    __defined at:__ @botan\/ffi.h:2137:40@
...
{-| __C declaration:__ @botan_x509_cert_key_constraints@

    __defined at:__ @botan\/ffi.h:2187:6@
...
{-| __C declaration:__ @NO_CONSTRAINTS@
    ...
    __defined at:__ @botan\/ffi.h:2188:4@
...
{-| __C declaration:__ @DIGITAL_SIGNATURE@
    ...
    __defined at:__ @botan\/ffi.h:2189:4@
...
{-| __C declaration:__ @NON_REPUDIATION@
    ...
    __defined at:__ @botan\/ffi.h:2190:4@
...
{-| __C declaration:__ @KEY_ENCIPHERMENT@
    ...
    __defined at:__ @botan\/ffi.h:2191:4@
...
{-| __C declaration:__ @DATA_ENCIPHERMENT@
    ...
    __defined at:__ @botan\/ffi.h:2192:4@
...
{-| __C declaration:__ @KEY_AGREEMENT@
    ...
    __defined at:__ @botan\/ffi.h:2193:4@
...
{-| __C declaration:__ @KEY_CERT_SIGN@
    ...
    __defined at:__ @botan\/ffi.h:2194:4@
...
{-| __C declaration:__ @CRL_SIGN@
    ...
    __defined at:__ @botan\/ffi.h:2195:4@
...
{-| __C declaration:__ @ENCIPHER_ONLY@
    ...
    __defined at:__ @botan\/ffi.h:2196:4@
...
{-| __C declaration:__ @DECIPHER_ONLY@
    ...
    __defined at:__ @botan\/ffi.h:2197:4@
...
{-| __C declaration:__ @botan_x509_crl_struct@

    __defined at:__ @botan\/ffi.h:2238:16@
...
{-| __C declaration:__ @botan_x509_crl_t@
    ...
    __defined at:__ @botan\/ffi.h:2238:39@
...
{-| __C declaration:__ @botan_hotp_struct@

    __defined at:__ @botan\/ffi.h:2315:16@
...
__defined at:__ @botan\/ffi.h:2315:35@
...
{-| __C declaration:__ @botan_totp_struct@

    __defined at:__ @botan\/ffi.h:2347:16@
...
__defined at:__ @botan\/ffi.h:2347:35@
...
{-| __C declaration:__ @botan_fpe_struct@

    __defined at:__ @botan\/ffi.h:2387:16@
...
__defined at:__ @botan\/ffi.h:2387:34@
...
{-| __C declaration:__ @BOTAN_FPE_FLAG_FE1_COMPAT_MODE@
    ...
    __defined at:__ @botan\/ffi.h:2389:9@
...
{-| __C declaration:__ @botan_srp6_server_session_struct@

    __defined at:__ @botan\/ffi.h:2410:16@
...
__defined at:__ @botan\/ffi.h:2410:50@
...
{-| __C declaration:__ @botan_tpm2_ctx_struct@

    __defined at:__ @botan\/ffi.h:2568:16@
...
__defined at:__ @botan\/ffi.h:2568:39@
...
{-| __C declaration:__ @botan_tpm2_session_struct@

    __defined at:__ @botan\/ffi.h:2573:16@
...
__defined at:__ @botan\/ffi.h:2573:43@
...
{-| __C declaration:__ @botan_tpm2_crypto_backend_state_struct@

    __defined at:__ @botan\/ffi.h:2578:16@
...
__defined at:__ @botan\/ffi.h:2578:56@
...
{-| __C declaration:__ @ESYS_CONTEXT@

    __defined at:__ @botan\/ffi.h:2580:8@

    __exported by:__ @botan\/ffi.h@
-}
data ESYS_CONTEXT

foreign import ccall safe "wrapper" funPtr_0b8de268_to ::
     (Botan_view_ctx -> (Ptr.Ptr FC.CChar) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt)
  -> IO (Ptr.FunPtr (Botan_view_ctx -> (Ptr.Ptr FC.CChar) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt))

foreign import ccall safe "dynamic" funPtr_0b8de268_from ::
     Ptr.FunPtr (Botan_view_ctx -> (Ptr.Ptr FC.CChar) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt)
  -> Botan_view_ctx -> (Ptr.Ptr FC.CChar) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt

instance HsBindgen.Runtime.FunPtr.ToFunPtr (Botan_view_ctx -> (Ptr.Ptr FC.CChar) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt) where

  toFunPtr = funPtr_0b8de268_to

instance HsBindgen.Runtime.FunPtr.FromFunPtr (Botan_view_ctx -> (Ptr.Ptr FC.CChar) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt) where

  fromFunPtr = funPtr_0b8de268_from

foreign import ccall safe "wrapper" funPtr_9c04e438_to ::
     (Botan_view_ctx -> (Ptr.Ptr HsBindgen.Runtime.Prelude.Word8) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt)
  -> IO (Ptr.FunPtr (Botan_view_ctx -> (Ptr.Ptr HsBindgen.Runtime.Prelude.Word8) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt))

foreign import ccall safe "dynamic" funPtr_9c04e438_from ::
     Ptr.FunPtr (Botan_view_ctx -> (Ptr.Ptr HsBindgen.Runtime.Prelude.Word8) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt)
  -> Botan_view_ctx -> (Ptr.Ptr HsBindgen.Runtime.Prelude.Word8) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt

instance HsBindgen.Runtime.FunPtr.ToFunPtr (Botan_view_ctx -> (Ptr.Ptr HsBindgen.Runtime.Prelude.Word8) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt) where

  toFunPtr = funPtr_9c04e438_to

instance HsBindgen.Runtime.FunPtr.FromFunPtr (Botan_view_ctx -> (Ptr.Ptr HsBindgen.Runtime.Prelude.Word8) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt) where

  fromFunPtr = funPtr_9c04e438_from
