...
foreign import capi "botan/ffi.h botan_cipher_init"
    botan_cipher_init
...
foreign import capi "botan/ffi.h botan_cipher_name"
    botan_cipher_name
        :: BotanCipher -- ^ cipher
        -> Ptr CChar      -- ^ name
        -> Ptr CSize      -- ^ name_len
...
foreign import capi "botan/ffi.h botan_cipher_output_length"
...
foreign import capi "botan/ffi.h botan_cipher_valid_nonce_length"
...
foreign import capi "botan/ffi.h botan_cipher_get_tag_length"
...
foreign import capi "botan/ffi.h botan_cipher_get_default_nonce_length"
...
foreign import capi "botan/ffi.h botan_cipher_get_update_granularity"
...
-}
foreign import capi "botan/ffi.h botan_cipher_get_ideal_update_granularity"
...
foreign import capi "botan/ffi.h botan_cipher_query_keylen"
...
foreign import capi "botan/ffi.h botan_cipher_get_keyspec"
...
foreign import capi "botan/ffi.h botan_cipher_set_key"
...
-}
foreign import capi "botan/ffi.h botan_cipher_reset"
    botan_cipher_reset
        :: BotanCipher -- ^ cipher
        -> IO CInt

-- | Set the associated data. Will fail if cipher is not an AEAD
foreign import capi "botan/ffi.h botan_cipher_set_associated_data"
...
foreign import capi "botan/ffi.h botan_cipher_start"
    botan_cipher_start
        :: BotanCipher  -- ^ cipher
...
-- | Encrypt some data
foreign import capi "botan/ffi.h botan_cipher_update"
    botan_cipher_update
        :: BotanCipher  -- ^ cipher
        -> Word32          -- ^ flags
        -> Ptr Word8       -- ^ output[]
...
foreign import capi "botan/ffi.h botan_cipher_clear"
    botan_cipher_clear
        :: BotanCipher -- ^ hash
        -> IO CInt
